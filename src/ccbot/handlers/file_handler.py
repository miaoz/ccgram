...
Saves uploaded files to `.ccbot-uploads/` in the session's cwd, then sends
...
async def handle_photo_message(
    ...
    """Handle photo uploads: save to .ccbot-uploads/ and notify Claude."""
...
async def handle_document_message(
    ...
    """Handle document uploads: save to .ccbot-uploads/ and notify Claude."""
    user = update.effective_user
    message = update.message
